            ...
            <div class="container-fluid px-4 my-3 mx-3">
                ...
                <div class="myTable">
                    <table id="mytable">
                        ...
                        FROM donor, patient, bloodrequest WHERE bloodrequest.d_no!=0 AND bloodrequest.p_no=patient.p_no AND bloodrequest.r_status='Pending'
                        ...
                        if($num2>0){
                            ...
                            while($row2= mysqli_fetch_assoc($result2)){
                                ...
                                <td id="admin"></td>
                               <td><button type="button" id="'.$row2['r_no'].'"  class="accept btn btn-primary btn-xm ">Confirm</button></td>
                             </tr>';
                            $a_sl=$a_sl+1;
                        }
                    }
